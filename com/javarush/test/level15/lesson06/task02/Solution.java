...
/**
 * JavaRush.ru
 * Level 15, Lesson 06, Task 02
 * <p/>
 * Максимально простой код. <b/>
 * Посмотри, что, связанное с конструкторами, может быть добавлено при компиляции, но в этой программе уже
 * присутствует. Упрости код - удали все конструкторы и вызовы конструкторов супер-классов, которые создаются и
 * добавляются автоматически.
 * <p/>
 * PS: Взаимосвязь между объектами классов NakedCat и NormalCat, SiamCat - Is-a (наследование):
 * http://en.wikipedia.org/wiki/Is-a,  http://cs7002.vk.me/c7007/v7007577/1411a/_dAiEola310.jpg
 * <p/>
 * Date: 06.05.13
