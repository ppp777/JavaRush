...
/**
 * JavaRush.ru
 * Level 16, Lesson 05, Task 01
 * <p/>
 * Поумайте, в каком месте и для какого объекта нужно вызвать метод join, чтобы результат выводился по-порядку
 * сначала для:
 * firstThread, а потом для secondThread
